...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-900 via-blue-900 to-purple-900 flex items-center justify-center py-12 px-4 sm:px-6 relative overflow-hidden font-sans">
