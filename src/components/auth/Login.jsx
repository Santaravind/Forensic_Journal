...
//   return (
//     <div className="min-h-screen bg-linear-to-br from-purple-900 via-indigo-900 to-blue-900 py-12 px-4 sm:px-6 lg:px-8 flex items-center justify-center">
...
//             <div className="w-16 h-16 bg-linear-to-br from-purple-400 to-indigo-400 rounded-lg flex items-center justify-center shadow-lg shadow-purple-500/50">
