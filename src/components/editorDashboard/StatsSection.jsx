...
export default function StatsSection({ papers = [], onNavigateTab = () => {} }) {
  ...
  // Dynamic counts derived from live papers array as authoritative fallback
  ...
  const awaitingDecisionCount = papers.filter((p) => {
  ...
  const stats = [
    ...
    },
    {
      ...
      subtext: "Awaiting initial editor check",
      icon: Layers,
      color: "text-blue-600",
      bg: "bg-blue-50",
    ...
    },
    {
      ...
      subtext: "Assigned to peer reviewers",
      icon: Clock,
    ...
    },
    {
      ...
      subtext: "Reviews in • Judgment pending",
      icon: AlertCircle,
    ...
    },
    {
      ...
      subtext: "Live online with registered DOI",
      icon: Sparkles,
      color: "text-pink-600",
      bg: "bg-pink-50",
      border: "border-slate-200/90 hover:border-pink-300",
      tab: "Manuscripts",
    },
  ];
