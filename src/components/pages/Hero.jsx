...
import bg1 from "../assets/self-1.jpeg";
import bg from "../assets/self-2.jpeg";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          ...
          <div className="text-white max-w-3xl">
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 ml-8 leading-tight animate-fadeInUp">
              Forensic Patrika
              <span className="block text-2xl md:text-4xl lg:text-5xl text-indigo-200 mt-4 ml-2.5">
                {" "}
            ...
            <p className="text-xl md:text-2xl mb-8 ml-8 text-gray-200 leading-relaxed animate-fadeInUp animation-delay-200 ">
              ...
              A peer-reviewed journal dedicated to excellence in forensic
              science.
            </p>
