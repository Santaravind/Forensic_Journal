      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-8 md:p-12 space-y-6 text-slate-700 leading-relaxed">
          ...
          <p>
            ...
            of its authors, reviewers, and readers. The journal recognizes the
          ...
          {/* Confidentiality */}
          <p>
            All submitted manuscripts and reviewer reports are treated as
            strictly confidential and are accessible only to authorized members
            of the editorial and review team. Confidentiality is maintained
            throughout the submission, review, and publication process.
          </p>

          {/* Security */}
          <p>
            The platform employs reasonable administrative and technical
          ...
          <div className="bg-indigo-50 border-l-4 border-indigo-600 rounded-r-xl p-6">
            <p>
              By submitting a manuscript or registering with{" "}
              <span className="font-semibold text-slate-900">
                FORENSIC PATRIKA : A Journal of Forensic Science
              </span>
              , users consent to the collection and use of their information
          ...
          <p>
            ...
            necessary to reflect changes in operational practices,
            technological developments, or legal and regulatory requirements.
          </p>
