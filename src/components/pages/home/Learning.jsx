...
export default function LearningResources() {
  ...
  <div className="flex items-center justify-between">
    ...
    {/* Buy Now */}
    <button className="relative px-5 py-2 text-sm font-semibold text-white rounded-xl bg-gradient-to-r from-indigo-600 to-blue-600 shadow-md hover:shadow-lg hover:scale-[1.02] active:scale-95 transition-all duration-200">
      BUY NOW
    </button>
