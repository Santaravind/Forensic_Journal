...
export default function Sidebar({
  ...
  const currentUser = authService.getCurrentUser() || {
    fullName: "Mr. Indresh Kumar",
    email: "reviewer@forensicpatrika.com",
    role: "REVIEWER",
  };
  ...
  const navSections = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          badgeType: "warning",
          hint: "Action & Evaluation Required",
        },
        {
          id: "Completed",
          ...
          badgeType: "success",
          hint: "Submitted Reports Archive",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          icon: Calendar,
          hint: "Timeline & Due Dates",
        },
        {
          id: "Guidelines",
          label: "Reviewer Rubric & Ethics",
          icon: BookOpen,
          badge: "COPE",
          badgeType: "live",
          hint: "Criteria, Scoring & AI Policy",
        },
      ],
    },
  ];
          ...
          <div className="p-4 pb-3 border-b border-white/[0.08] relative overflow-hidden">
            ...
            <div className="mt-3.5 bg-white/[0.04] border border-white/[0.06] rounded-xl px-3 py-1.5 flex items-center justify-between text-[11px] text-slate-400">
              <div className="flex items-center gap-1.5">
                ...
                <span className="font-semibold text-slate-300">Peer Review Gateway</span>
              </div>
              ...
              <div className="flex items-center gap-2.5 min-w-0">
                ...
                <div className="min-w-0">
                  <p className="text-xs font-bold text-white truncate leading-tight">
                    {currentUser.fullName || "Peer Reviewer"}
                  </p>
                  <p className="text-[10px] text-indigo-300/80 truncate font-medium">
                    {currentUser.email || "reviewer@forensicpatrika.com"}
                  </p>
                </div>
              </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-1.5 shrink-0 ml-2">
                          {item.badge && (
                            <span
                              className={`px-2 py-0.5 rounded-full text-[9px] font-extrabold transition-all flex items-center gap-1 ${getBadgeClass(
                                item.badgeType
                              )}`}
                            >
                              {item.badge}
